package firstfroupapp.ak.twitterproducer;
...
public class TweetProducer {
    ...
    String consumerKey = "i0qQ2oMYgWfTAt0sK9MXfAV0R";//specify the consumer key from the twitter app
    String consumerSecret =
            "5ONoM9t5BgoJaZAZbQFcGxkpmrkUpYVtFsRjETpsyN8G5ceEAv";//specify the consumerSecret key from the twitter app
    String token = "1100378462987210752-jDC05VgPZe71YrS9gaqESjbQeIqUW0";//specify the token key from the twitter app
    String secret = "xyUvwJkwdDXESshSgZM9lZnwGsQJmlnooKHZT07yR4hWG";//specify the secret key from the twitter app
